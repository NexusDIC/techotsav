  ...
  return (
    <div>
      <a
        ...
        className="lg:mt-5 relative inline-block px-4 py-2 border-2 border-[#ffffff] text-[#ffffff] text-lg uppercase tracking-wide font-medium overflow-hidden transition-all duration-700 ease-out hover:text-black group"
      >
