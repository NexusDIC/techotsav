...
const Button: React.FC<ButtonProps> = ({ title, href }) => {
  return (
    <div><h1 className='text-white'>Check out Our Hackathon</h1><a 
    href={href} 
    target="_blank" 
  ...
  >
    <span className="absolute w-0 h-[300%] bg-[#ffffff] top-1/2 left-1/2 origin-center rotate-[45deg] translate-x-[-50%] translate-y-[-50%] transition-all duration-700 ease-out group-hover:w-[105%]" />
